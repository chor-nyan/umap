...
#             indices = rejection_sample(n_neighbors, data.shape[0], rng_state)
#             for j in range(indices.shape[0]):
#                 d = dist(data[i], data[indices[j]], i, indices[j], *dist_args)
#                 heap_push(current_graph, i, d, indices[j], 1)
#                 heap_push(current_graph, indices[j], d, i, 1)
#
#         if rp_tree_init:
...
#                             break
#                         d = dist(
#                             data[leaf_array[n, i]], data[leaf_array[n, j]], leaf_array[n, i], leaf_array[n, j], *dist_args
#                         )
#                         heap_push(
#                             current_graph, leaf_array[n, i], d, leaf_array[n, j], 1
#                         )
...
#                             continue
#
#                         d = dist(data[p], data[q], p, q, *dist_args)
#                         c += heap_push(current_graph, p, d, q, 1)
#                         c += heap_push(current_graph, q, d, p, 1)
#
#             if c <= delta * n_neighbors * data.shape[0]:
