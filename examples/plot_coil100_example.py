...
#     plt.scatter(u_org[:,0], u_org[:,1], c=labels, cmap="Spectral", s=10, alpha=0.5)
#     plt.show()
#
#     plt.scatter(u_hub[:,0], u_hub[:,1], c=labels, cmap="Spectral", s=10, alpha=0.5)
#     plt.show()
#
#     # 1-NN
...
# savetxt('/home/hino/git/umap2/examples/result_hub_COIL100.csv', result_hub)
    ...
    # r_lst_org, p_org = mantel_test(data, labels, u_org)
    # r_lst_hub, p_hub = mantel_test(data, labels, u_hub)
    #
    # fig = plt.figure()
